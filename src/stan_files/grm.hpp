...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_grm");
    reader.add_event(42, 40, "end", "model_grm");
    return reader;
}

#include <meta_header.hpp>
 class model_grm : public prob_grad {
private:
    int N;
    int J;
    vector<int> K;
    ...
    double scale_a;
public:
    model_grm(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_grm_namespace::model_grm";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "K", "int", context__.to_vec(J));
            validate_non_negative_index("K", "J", J);
            K = std::vector<int>(J,int(0));
            vals_i__ = context__.vals_i("K");
            pos__ = 0;
            size_t K_limit_0__ = J;
            ...
            context__.validate_dims("data initialization", "y", "int", context__.to_vec(N,J));
            validate_non_negative_index("y", "N", N);
            validate_non_negative_index("y", "J", J);
            y = std::vector<std::vector<int> >(N,std::vector<int>(J,int(0)));
            vals_i__ = context__.vals_i("y");
            pos__ = 0;
            size_t y_limit_1__ = J;
            ...
            for (int k0__ = 0; k0__ < J; ++k0__) {
                check_greater_or_equal(function__,"K[k0__]",K[k0__],2);
            }
            current_statement_begin__ = 5;
            for (int k0__ = 0; k0__ < N; ++k0__) {
                for (int k1__ = 0; k1__ < J; ++k1__) {
                    check_greater_or_equal(function__,"y[k0__][k1__]",y[k0__][k1__],1);
                    check_less_or_equal(function__,"y[k0__][k1__]",y[k0__][k1__],max(K));
                }
            }
            current_statement_begin__ = 6;
            current_statement_begin__ = 7;
            ...
            validate_non_negative_index("b", "(max(K) - 1)", (max(K) - 1));
            validate_non_negative_index("b", "J", J);
            num_params_r__ += (max(K) - 1) * J;
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("a", "J", J);
        context__.validate_dims("initialization", "a", "double", context__.to_vec(J));
        std::vector<double> a(J,double(0));
        ...
        validate_non_negative_index("b", "J", J);
        validate_non_negative_index("b", "(max(K) - 1)", (max(K) - 1));
        context__.validate_dims("initialization", "b", "vector_d", context__.to_vec(J,(max(K) - 1)));
        std::vector<vector_d> b(J,vector_d(static_cast<Eigen::VectorXd::Index>((max(K) - 1))));
        for (int j1__ = 0U; j1__ < (max(K) - 1); ++j1__)
            for (int i0__ = 0U; i0__ < J; ++i0__)
                b[i0__](j1__) = vals_r__[pos__++];
        for (int i0__ = 0U; i0__ < J; ++i0__)
            try {
            writer__.ordered_unconstrain(b[i0__]);
        } catch (const std::exception& e) { 
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            vector<Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1> > b;
            size_t dim_b_0__ = J;
            b.reserve(dim_b_0__);
            for (size_t k_0__ = 0; k_0__ < dim_b_0__; ++k_0__) {
                if (jacobian__)
                    b.push_back(in__.ordered_constrain((max(K) - 1),lp__));
                else
                    b.push_back(in__.ordered_constrain((max(K) - 1)));
            }
            ...
            for (int j = 1; j <= J; ++j) {
                ...
                for (int k = 1; k <= (get_base1(K,j,"K",1) - 1); ++k) {

                    current_statement_begin__ = 28;
                    lp_accum__.add(normal_log<propto__>(get_base1(get_base1(b,j,"b",1),k,"b",2), mu_b, sigma_b));
                }
            }
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                for (int j = 1; j <= J; ++j) {
                    ...
                    lp_accum__.add(ordered_logistic_log<propto__>(get_base1(get_base1(y,i,"y",1),j,"y",2), ((D * get_base1(a,j,"a",1)) * get_base1(theta,i,"theta",1)), multiply((D * get_base1(a,j,"a",1)),stan::model::rvalue(b, stan::model::cons_list(stan::model::index_uni(j), stan::model::cons_list(stan::model::index_min_max(1, (get_base1(K,j,"K",1) - 1)), stan::model::nil_index_list())), "b"))));
                }
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "model_grm_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        vector_d theta = in__.vector_constrain(N);
        vector<double> a;
        size_t dim_a_0__ = J;
        for (size_t k_0__ = 0; k_0__ < dim_a_0__; ++k_0__) {
            a.push_back(in__.scalar_lb_constrain(0));
        ...
        for (size_t k_0__ = 0; k_0__ < dim_b_0__; ++k_0__) {
            ...
            for (int k_1__ = 0; k_1__ < (max(K) - 1); ++k_1__) {
                for (int k_0__ = 0; k_0__ < J; ++k_0__) {
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (int k_1__ = 1; k_1__ <= (max(K) - 1); ++k_1__) {
            for (int k_0__ = 1; k_0__ <= J; ++k_0__) {
                param_name_stream__.str(std::string());
...
typedef model_grm_namespace::model_grm stan_model;
